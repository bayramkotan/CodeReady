...
| v2.3.4 | Uninstall Phase 2c-1 — codeready.ps1: Windows uninstall engine (winget/scoop/choco) + 16 cloud CLI parity (scan + install) | ✅ Shipped |
| v2.3.5 | Uninstall Phase 2c-2 — GUI: scanner.rs/definitions.rs + frontend uninstall + cloud parity + scan-json contract extension (both sh and ps1) | Next |
